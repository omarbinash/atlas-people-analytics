...
- ⏳ **Phase 2C** — IDENTITY MATCHER — the core engineering work, three-pass deterministic + stewardship queue, NEXT
- 🔜 **Phase 2D** — dim_employee SCD2 + fct_workforce_daily snapshot
...
## Phase 2C — what's already designed
...
4. **Run tests after every model change** — Phase 2C will introduce real test coverage; never push code that hasn't passed `dbt test`
